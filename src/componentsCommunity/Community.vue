        ...
        <el-col :span="6">
          ...
          <div class="related-communities mb-3">
            <el-card shadow="hover" class="related-card">
              ...
              <div
                ...
                v-for="(community, index) in guessLikeItems"
                :key="index"
          ...
          <div class="sidebar">
            <el-card shadow="hover" class="recommend-card">
              ...
              <div
                class="recommend-item"
                v-for="(community, index) in popularCommunities"
                :key="index"
                @click="navigateToCommuDetail(community)"
              >
                <el-avatar
    ...
    <div class="form-container">
      ...
      >
        ...
        <el-form-item label="社区描述">
          <el-input
            v-model="form.communityDescription"
            type="textarea"
            placeholder="简要描述社区内容"
            autosize
          />
        </el-form-item>
        ...
        <el-form-item label="所属类别">
          ...
          >
            <el-option
              v-for="cat in filteredCatIdAndName"
              :key="cat.categoryId"
      ...
      <div class="form-footer">
        <el-button @click="dialogFormVisible = false" class="btn-cancel"
          >取消</el-button
        >
        <el-button type="primary" @click="createCommunity" class="btn-submit"
          >创建社区</el-button
        >
      </div>
    </div>
