...
.content {
  ...
  align-items: flex-start; /* 默认靠左对齐所有子元素 */
  padding: 20px; /* 内边距 */
}
...
.steps-container {
  ...
  width: 100%; /* 充满父容器宽度 */
  margin: 20px auto; /* 上下边距，左右自动，实现水平居中 */
}
...
.info-content {
  font-size: 14px;
  color: #666;
  white-space: normal; /* 允许内容换行，但不影响标题 */
}
/* 特定信息项的样式，如果需要特殊对齐 */
.special-item {
  text-align: center; /* 居中对齐 */
}
.left-panel .title, .right-panel .header {
